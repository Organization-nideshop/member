<template>
  <div class="page-palettebutton">
    <gheader :examplename="examplename"></gheader>
    <div class="page-palettebutton-wrapper">
      <mt-palette-button content="+" @expand="main_log('expand')"
        ...
        <div class="my-icon-button indexicon icon-popup"
          @touchstart="sub_log(2)"></div>
        <div class="my-icon-button indexicon icon-popup"
          @touchstart="sub_log(3)"></div>
      </mt-palette-button>
      <mt-palette-button content="+" @expand="main_log('expand')"
        @expanded="main_log('expanded')"
        @collapse="main_log('collapse')"
        ...
        <div class="my-icon-button indexicon icon-popup" @tochstart="sub_log(2)"></div>
        <div class="my-icon-button indexicon icon-popup" @tochstart="sub_log(3)"></div>
        <div class="my-icon-button indexicon icon-popup" @tochstart="sub_log(4)"></div>
        <div class="my-icon-button indexicon icon-popup" @tochstart="sub_log(5)"></div>
